...
<div class="mx-auto" role="group" aria-label="Basic example" align="center">
  ...
  <a href="{{ url('/category/wise/post/') }}/{{$category->id}}" title="" class="btn btn-sm btn-secondary mb-2">{{$category->category_name}}</a>
...
<h5 class="text-muted mb-4 mt-1" align="center">Works Avaliable</h5>
